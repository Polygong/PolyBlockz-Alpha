...
public class Block_BlokkHouse_middl extends Block {
	...
	public Block_BlokkHouse_middl(int par1) {
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Block_Helper.BlokkHouse_middl.blockID;
	}

	public void onBlockClicked(World world, int par2, int par3, int par4,
			EntityPlayer par5EntityPlayer) {
		Block_Helper.generateBlokkHouse_middl(world, null, par2, par3, par4);
	}
