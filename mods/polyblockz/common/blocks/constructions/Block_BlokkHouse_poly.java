...
public class Block_BlokkHouse_poly extends Block {
	...
	public Block_BlokkHouse_poly(int par1) {
	...
	public void registerIcons(IconRegister par1RegisterIcon) {
		this.blockIcon = par1RegisterIcon
				.registerIcon("polyblockz:blokkhouse_poly_side");
		blockIconTop = par1RegisterIcon.registerIcon("polyblockz:blokkhouse_poly_top"); // TOP
		blockIconBottom = par1RegisterIcon
				.registerIcon("polyblockz:blokkhouse_bottom"); // BOTTOM
		blockIconDoorSide = par1RegisterIcon
				.registerIcon("polyblockz:blokkhouse_poly_doorside"); // DOOR
	}
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Block_Helper.BlokkHouse_poly.blockID;
	}

	public void onBlockClicked(World world, int par2, int par3, int par4,
			EntityPlayer par5EntityPlayer) {
		Block_Helper.generateBlokkHouse_poly(world, null, par2, par3, par4);
	}
