...
public class Block_BlokkHouse_hidingplace extends Block {
	...
	public Block_BlokkHouse_hidingplace(int par1) {
	...
	public void registerIcons(IconRegister par1RegisterIcon) {
		this.blockIcon = par1RegisterIcon
				.registerIcon("polyblockz:blokkhouse_bottom");
		blockIconTop = par1RegisterIcon.registerIcon("polyblockz:blokkhouse_bottom"); // TOP
		blockIconBottom = par1RegisterIcon
				.registerIcon("polyblockz:blokkhouse_bottom"); // BOTTOM
		blockIconDoorSide = par1RegisterIcon
				.registerIcon("polyblockz:blokkhouse_hidingplace_doorside"); // DOOR
	}
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Block_Helper.BlokkHouse_hidingplace.blockID;
	}

	public void onBlockClicked(World world, int par2, int par3, int par4,
			EntityPlayer par5EntityPlayer) {
		Block_Helper.generateBlokkHouse_hidingplace(world, null, par2, par3, par4);
	}
