...
public class Torch_WhiteLamp extends Block {
	/** Whether this button is sensible to arrows, used by wooden buttons. */

	public Torch_WhiteLamp(int par1, Material mat) {
		super(par1, mat);
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("polyblockz:sticklamp_white");
	}
