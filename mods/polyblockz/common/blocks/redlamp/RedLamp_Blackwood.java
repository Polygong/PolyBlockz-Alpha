...
public class RedLamp_Blackwood extends Block {
	/** Whether this lamp block is the powered version. */
	private final boolean powered;

	public RedLamp_Blackwood(int par1, boolean par2) {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		if (this.powered) {
			this.blockIcon = par1IconRegister
					.registerIcon("polyblockz:redlamp_active_blackplank");
		} else {
			this.blockIcon = par1IconRegister
					.registerIcon("polyblockz:redlamp_idle_blackplank");
		}
	}
		...
		if (!par1World.isRemote) {
			if (this.powered
				...
				par1World.setBlock(par2, par3, par4,
						Block_Helper.blokklampActivewoodblack.blockID, 0, 2);
			}
		}
	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4,
		...
		if (!par1World.isRemote && this.powered
			...
			par1World.setBlock(par2, par3, par4,
					Block_Helper.blokklampIdlewoodblack.blockID, 0, 2);
		}
	}
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Block_Helper.blokklampIdlewoodblack.blockID;
	}
