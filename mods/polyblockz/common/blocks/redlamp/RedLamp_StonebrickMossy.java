...
public class RedLamp_StonebrickMossy extends Block {
	/** Whether this lamp block is the powered version. */
	private final boolean powered;

	public RedLamp_StonebrickMossy(int par1, boolean par2) {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		if (this.powered) {
			this.blockIcon = par1IconRegister
					.registerIcon("polyblockz:redlamp_active_stonebrick_mossy");
		} else {
			this.blockIcon = par1IconRegister
					.registerIcon("polyblockz:redlamp_idle_stonebrick_mossy");
		}
	}
			...
			if (this.powered
				...
				par1World
						.setBlock(
								...
								par3,
								par4,
								Block_Helper.blokklampActivestonebricksmooth_mossy.blockID,
								0, 2);
			}
		}
	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4,
		...
		if (!par1World.isRemote && this.powered
			...
			par1World.setBlock(par2, par3, par4,
					Block_Helper.blokklampIdlestonebricksmooth_mossy.blockID,
					0, 2);
		}
	}
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Block_Helper.blokklampIdlestonebricksmooth_mossy.blockID;
	}
