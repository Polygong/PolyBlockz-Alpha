...
public class RedLamp_Dirtbrickfine extends Block {
	/** Whether this lamp block is the powered version. */
	private final boolean powered;

	public RedLamp_Dirtbrickfine(int par1, boolean par2) {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		if (this.powered) {
			this.blockIcon = par1IconRegister
					.registerIcon("polyblockz:redlamp_active_dirtbrickfine");
		} else {
			this.blockIcon = par1IconRegister
					.registerIcon("polyblockz:redlamp_idle_dirtbrickfine");
		}
	}
			...
			if (this.powered
				...
				par1World
						.setBlock(
								...
								par3,
								par4,
								Block_Helper.blokklampActivedirtbrickfine.blockID,
								0, 2);
			}
		}
	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4,
		...
		if (!par1World.isRemote && this.powered
			...
			par1World.setBlock(par2, par3, par4,
					Block_Helper.blokklampIdledirtbrickfine.blockID, 0, 2);
		}
	}
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Block_Helper.blokklampIdledirtbrickfine.blockID;
	}
