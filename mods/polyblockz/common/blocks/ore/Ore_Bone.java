...
public class Ore_Bone extends Block {

	private boolean requiresNoTool;

	public Ore_Bone(int id, Material mat) {
		super(id, mat);
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("polyblockz:ore_bone");
	}
	...
	protected Ore_Bone setRequiresTool() {
