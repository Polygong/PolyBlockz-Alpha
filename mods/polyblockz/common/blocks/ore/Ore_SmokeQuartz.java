...
public class Ore_SmokeQuartz extends Block {

	private boolean requiresNoTool;

	public Ore_SmokeQuartz(int id, Material mat) {
		super(id, mat);
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("polyblockz:ore_smokequartz");
	}

	@Override
	public int idDropped(int par1, Random par2Random, int par3) {
		return Item_Helper.SmokeQuartz.itemID;
	...
	protected Ore_SmokeQuartz setRequiresTool() {
