...
public class Ore_Saphir extends Block {

	private boolean requiresNoTool;

	public Ore_Saphir(int id, Material mat) {
		super(id, mat);
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("polyblockz:ore_saphir");
	}

	@Override
	public int idDropped(int par1, Random par2Random, int par3) {
		return Item_Helper.Saphir.itemID;
	...
	protected Ore_Saphir setRequiresTool() {
