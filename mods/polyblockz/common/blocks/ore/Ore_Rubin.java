...
public class Ore_Rubin extends Block {

	private boolean requiresNoTool;

	public Ore_Rubin(int id, Material mat) {
		super(id, mat);
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("polyblockz:ore_rubin");
	}

	@Override
	public int idDropped(int par1, Random par2Random, int par3) {
		return Item_Helper.Rubin.itemID;
	...
	protected Ore_Rubin setRequiresTool() {
