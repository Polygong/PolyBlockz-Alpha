...
public class Ore_Citrion extends Block {

	private boolean requiresNoTool;

	public Ore_Citrion(int id, Material mat) {
		super(id, mat);
	...
	public void registerIcons(IconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon("polyblockz:ore_citrin");
	}

	@Override
	public int idDropped(int par1, Random par2Random, int par3) {
		return Item_Helper.Citrin.itemID;
	...
	protected Ore_Citrion setRequiresTool() {
