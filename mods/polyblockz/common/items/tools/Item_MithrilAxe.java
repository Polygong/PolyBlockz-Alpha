...
public class Item_MithrilAxe extends ItemAxe {

	public Item_MithrilAxe(int i, EnumToolMaterial enumToolMaterial) {
	...
	public void registerIcons(IconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon("polyblockz:mithril_axe");
	}
