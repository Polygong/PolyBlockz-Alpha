...
public class Item_EmeraldAxe extends ItemAxe {

	public Item_EmeraldAxe(int i, EnumToolMaterial enumToolMaterial) {
	...
	public void registerIcons(IconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon("polyblockz:emerald_axe");
	}

	public boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World,
			int par3, int par4, int par5, int par6,
			EntityLivingBase par7EntityLivingBase) {
		if (par3 != Block.leaves.blockID && par3 != Block.web.blockID
